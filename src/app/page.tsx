      ...
      <section className="relative px-6 py-24 backdrop-blur-sm">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="relative">
            <div className="absolute left-1/2 transform -translate-x-px top-0 bottom-0 w-0.5 bg-gradient-to-b from-blue-500 via-purple-500 to-gray-600"></div>
                ...
                ?.map((exp, index) => {
                  ...
                  return (
                    <div key={exp.id} className="relative">
                      <div className="absolute left-1/2 transform -translate-x-1/2 z-10 flex h-4 w-4 items-center justify-center rounded-full bg-blue-500 border-4 border-gray-900 shadow-lg"></div>
